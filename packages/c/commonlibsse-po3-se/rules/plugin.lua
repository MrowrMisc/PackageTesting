-- Usage:
--
-- add_rules("@commonlibsse-po3-se/plugin", {
--     name = "Plugin name",
--     author = "Author name",
...
rule("plugin")
    ...
    on_config(function(target)
        ...
        target:add("defines", "BOOST_STL_INTERFACES_DISABLE_CONCEPTS")

        target:set("kind", "shared")
        target:set("arch", "x64")

        local version = semver.new(target:version() or "0.0.0")
        local configs = target:extraconf("rules", "@commonlibsse-po3-se/plugin")
